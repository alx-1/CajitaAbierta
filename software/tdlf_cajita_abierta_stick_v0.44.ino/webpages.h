...
"input[type=submit]{  background-color: #DD622D ;border: none;color: white;padding: 15px 20px;"
...
void monContentSensors(){
  ...
  " Sensor 1 <label for=\"sensor1Chan\">Channel</label><select name=\"sensor1Chan\" id=\"sensor1Chan\">"
  "<option value=\"\" disabled selected>"
  +sensor1Chan+
  "</option>"
  "<option value=\"1\">1</option><option value=\"2\">2</option><option value=\"3\">3</option><option value=\"4\">4</option><option value=\"5\">5</option><option value=\"6\">6</option><option value=\"7\">7</option><option value=\"8\">8</option><option value=\"9\">9</option><option value=\"10\">10</option><option value=\"11\">11</option><option value=\"12\">12</option><option value=\"13\">13</option><option value=\"14\">14</option><option value=\"15\">15</option><option value=\"16\">16</option></select>"
  ...
  " Sensor 2 <label for=\"sensor2Chan\">Channel</label><select name=\"sensor2Chan\" id=\"sensor2Chan\">"
  "<option value=\"\" disabled selected>"
  +sensor2Chan+
  "</option>"
  "<option value=\"1\">1</option><option value=\"2\">2</option><option value=\"3\">3</option><option value=\"4\">4</option><option value=\"5\">5</option><option value=\"6\">6</option><option value=\"7\">7</option><option value=\"8\">8</option><option value=\"9\">9</option><option value=\"10\">10</option><option value=\"11\">11</option><option value=\"12\">12</option><option value=\"13\">13</option><option value=\"14\">14</option><option value=\"15\">15</option><option value=\"16\">16</option></select>"
  ...
  "</li></ol>"
  //"</li><li>"
  //" Sensor 3 <label for=\"sensor3Chan\">Channel</label><select name=\"sensor3Chan\" id=\"sensor3Chan\"><option value=\"1\">1</option><option value=\"2\">2</option><option value=\"3\">3</option><option value=\"4\">4</option><option value=\"5\">5</option><option value=\"6\">6</option><option value=\"7\">7</option><option value=\"8\">8</option><option value=\"9\">9</option><option value=\"10\">10</option><option value=\"11\">11</option><option value=\"12\">12</option><option value=\"13\">13</option><option value=\"14\">14</option><option value=\"15\">15</option><option value=\"16\">16</option></select>"
...
String contentRecording = ""
      "<center><b>Recording</b></center><br>"
      "<b><center>"
      " <a href = \"/\"> WiFI </a>"
      " / <a href = \"accel.html\"> Accelerometer </a>"
      " / <a href = \"blowsuck.html\"> Blow/Suck </a>"
      ...
      "<p>"
      "<ol><li>"
      "</p><p><form method='get' action='recordcfg'>"
      "<INPUT type=\"submit\" value=\"record\">"
      "</form>"
      "</li><li>"
      "</p><p><form method='get' action='recordingStandAlone'>"
      "<INPUT type=\"submit\" value=\"record no WiFI\">"
      "</form>"
      "</li><li>"
      "</p><p><form method='get' action='savecfg'>"
      "<INPUT type=\"submit\" value=\"save\" style=\">"
      "</form>"
      "</li><li>"
      "</p><p><form method='get' action='playcfg'>"
      "<INPUT type=\"submit\" value=\"play\">"
      "<label> BPM : </label><input type ='text' name='bpm' style=\"font-size:16px;\" size=4>"
      // need to add options for playback such as file name, speed or smoothing
      "</form>"
      "</li><li>"
      "</p><p><form method='get' action='erasecfg'>"
      "<INPUT type=\"submit\" value=\"erase files\">"
